...
3. .background-highlight[human-readable]: the file should be human-readable or have tools available for easy interpretation and debugging.

--

4. .background-highlight[Performance]: consideration for efficient read and write operations, especially for large datasets, is crucial for optimal performance.
...
`r fontawesome::fa("times", fill = "#E6352FFF")` 12-04-09 (2012-04-09 _or_ 2004-12-09 or 2009-04-12, or ...)
