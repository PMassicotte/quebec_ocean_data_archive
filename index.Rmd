...
- `readr` and `data.table` packages (.gradient-underline[the last one is particularly fast]).
...
<img src="img/data_rectangle_1.png" class="centerImage" width="700" alt="Data in a computer spreadsheet program.">
]
