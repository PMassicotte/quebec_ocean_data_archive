...
If a script changes the content of a raw data file, there are chances that the same script will not work again the second time you run it because the structure of the file has changed.
