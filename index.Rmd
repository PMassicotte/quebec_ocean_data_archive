...
<center>
<figure>
  <img src="https://blog.rstudio.com/2019/11/18/artist-in-residence/horst-eco-r4ds.png" width="600">
...
If a script changes the content of a raw data file and **save it in the same file**, .gradient-underline[it is likely that the script will not work the second time because the structure of the file has changed].
...
<center>
  <figure>
      <img src="img/species_wide.png" width = "800" alt="Image showing a frequent method to enter count data in spreadsheet softwares."/>
  </figure>
</center>
...
After proper transformations, the data is now tidy ([or in normal form](https://en.wikipedia.org/wiki/Database_normalization)). **Each column is a variable, each row is an observation.**

<center>
  <figure>
      <img src="img/species_wide_to_long.png" style="max-width: 1024px; height: auto; " alt="Image showing a frequent method to enter count data in spreadsheet softwares."/>
  </figure>
</center>
