...
- A common problem is that the columns values, not variable names.

!!!ADD IMAGE SKETCH HERE!!!

---

# A typical example

As an example, we will use a dataset where plant biomass of **three species** were measured under **two experimental treatments** in the Arctic Tundra.
...
**Each column is a variable, each row is an observations.**
