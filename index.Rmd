...
The data file format has important implications:
...
# Examples of CSV and TSV file

<!-- Screenshots made using maim -->
<!-- maim ~/Desktop/penguins_tsv_format.png -g 1300x725+4070+210 -->

This dataset contains 8 variables (columns). **The first line generally contains the names of the variables.**
